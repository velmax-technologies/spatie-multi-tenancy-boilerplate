...
{
    // success messages
    const LOGGEDIN_SUCCESSFULLY = 'User logged in successfully';
    const LOGGEDOUT_SUCCESSFULLY = 'User logged out successfully';
    ...
    const ERROR = [
        "UNAUATHENTICATED" => [
            ...
            "LONG" => "Unauthenticated! Pass the correct auth credentials."
        ],
        "UNAUTHORIZED" => [
            "CODE" => 403,
            "SHORT" => "Unauthorized!",
            "LONG" => "Unauthorized! You don't have rights to ther requested operation."
        ],
        "NOT_FOUND" => [
            "CODE" => 404,
        ...
        "UNPROCESSABLE" => [
            "CODE" => 422,
            "SHORT" => "Unprocessable request!",
            "LONG" => "Data validation failed!"
        ],
        "INTERNAL_SERVER_ERROR" => [
            "CODE" => 500,
            "SHORT" => "Internal server error!",
            "LONG" => "Internal server erro!"
        ],
    ];
}